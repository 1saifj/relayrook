...
export function route(input) {
  ...
  for (const candidate of candidates) {
    ...
    eligible.push({
      ...
      score: scoreCandidate(candidate, backend, table, policy, callerState),
    });
  }
  ...
  return {
    ...
    evidenceBasis: table.evidenceBasis,
    selected,
    rejected,
 ...
 */
function scoreCandidate(candidate, backend, table, policy, callerState) {
